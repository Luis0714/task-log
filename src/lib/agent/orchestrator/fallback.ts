...
const NO_TOOL_CALL_PATTERN = /no invocó ninguna herramienta/i;
const INVALID_ARGS_PATTERN = /argumentos inválidos/i;
const UNKNOWN_TOOL_PATTERN = /herramienta desconocida/i;
const SCHEMA_INVALID_PATTERN = /no cumple el esquema|formato inesperado/i;
