...
export const BUG_BAR_ATTENDED_CLASS = "bg-bug-attended";

export const BUG_CHART_OPEN_COLOR = "var(--bug-open)";
export const BUG_CHART_ATTENDED_COLOR = "var(--bug-attended)";
