...
import { ReportsSprintHoursExportRangeBanner } from "@/components/reports/sprint-hours/reports-sprint-hours-export-range-banner";
...
export type ReportsSprintHoursExportDialogProps = {
  project: string;
  team: string;
...
export function ReportsSprintHoursExportDialog({
  project,
  team,
  availableSprints,
  activeSprintWeeks,
  ...
  hiddenAssignees = [],
  disabled = false,
}: Readonly<ReportsSprintHoursExportDialogProps>) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col gap-5 py-2">
          ...
          {rangeInfo ? (
            <ReportsSprintHoursExportRangeBanner
